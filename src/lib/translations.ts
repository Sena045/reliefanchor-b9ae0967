...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    welcomeSubtitle: 'Calm your mind in 60 seconds.',
  ...
  hi: {
    ...
    welcomeSubtitle: '60 सेकंड में अपने मन को शांत करें।',
  ...
  es: {
    ...
    welcomeSubtitle: 'Calma tu mente en 60 segundos.',
  ...
  fr: {
    ...
    welcomeSubtitle: 'Calmez votre esprit en 60 secondes.',
  ...
  de: {
    ...
    welcomeSubtitle: 'Beruhigen Sie Ihren Geist in 60 Sekunden.',
  ...
  pt: {
    ...
    welcomeSubtitle: 'Acalme sua mente em 60 segundos.',
  ...
  ja: {
    ...
    welcomeSubtitle: '60秒で心を落ち着かせましょう。',
    talkToAnya: 'Anyaと話す',
    trackMood: '気分を記録',
